    ...
    <main className="min-h-[100dvh] bg-white">
      <section className="px-6 md:px-12 lg:px-20 pt-32 pb-12 md:pt-40 md:pb-16 bg-white">
        <div className="max-w-3xl mx-auto">
          ...
          <h1
            className="font-serif font-black text-[#0f1f20] mb-6 leading-tight"
      ...
      <section className="px-6 md:px-12 lg:px-20 pb-20 md:pb-28 bg-white">
        <div
          className="max-w-3xl mx-auto prose prose-lg max-w-none
            prose-headings:font-serif prose-headings:text-[#0f1f20] prose-headings:font-bold
            ...
            prose-blockquote:text-[#0f1f20] prose-blockquote:font-serif prose-blockquote:text-xl prose-blockquote:italic
      ...
      <section className="px-6 md:px-12 lg:px-20 py-16 md:py-24 bg-[#f4fafb] border-t border-[#d0e8ea]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h2 className="font-serif text-2xl md:text-3xl text-[#0f1f20] font-bold mb-6">
