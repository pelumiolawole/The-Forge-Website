          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6">
            ...
            <div className="group border border-[#d0e8ea] rounded-2xl overflow-hidden hover:border-[#008E97]/50 transition-colors duration-300">
              ...
              <div className="p-6 md:p-8">
                ...
                <p className="text-[#3d5a5c] mt-3 mb-5 text-sm md:text-base">Founder of IIC Networks. Creator of OneGoal Pro — an AI-powered goal system built on the same identity-first philosophy as The Forge System. One goal. One identity. Daily.</p>
                <Link href="https://onegoalpro.vercel.app" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-[#0f1f20] text-sm hover:text-[#008e97] transition-colors">
                  Try OneGoal Pro
                </Link>
              </div>
            </div>
