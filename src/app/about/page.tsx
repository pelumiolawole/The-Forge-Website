            ...
            <div className="grid lg:grid-cols-3 gap-12 lg:gap-8 relative">
              <div className="relative pl-12 lg:pl-0">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-[#6B6B6B] leading-relaxed">Honest diagnosis. What patterns are actually running you?</p>
                </div>
              </div>
              <div className="relative pl-12 lg:pl-0">
                <div className="absolute left-0 top-[1.5rem] lg:top-[1.5rem] w-3 h-3 rounded-full bg-[#008E97] lg:relative lg:mb-8" />
                <div className="space-y-3">
                  ...
                  <p className="text-[#6B6B6B] leading-relaxed">Identity architecture. Who are you becoming?</p>
                </div>
              </div>
              <div className="relative pl-12 lg:pl-0">
                <div className="absolute left-0 top-[1.5rem] lg:top-[1.5rem] w-3 h-3 rounded-full bg-[#008E97] lg:relative lg:mb-8" />
                <div className="space-y-3">
                  ...
                  <p className="text-[#6B6B6B] leading-relaxed">Sustained self-leadership. Who are you now, every day?</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="group p-8 border border-[#1A1A1A] rounded-xl hover:border-[#008E97] transition-colors duration-300">
              ...
              <p className="text-[#A3A3A3] mt-4 mb-6">Identity-based coaching for professionals and leaders.</p>
            ...
            <div className="group p-8 border border-[#1A1A1A] rounded-xl hover:border-[#008E97] transition-colors duration-300">
              ...
              <p className="text-[#A3A3A3] mt-4 mb-6">Petty Little Things — 50 habits quietly ruining your life.</p>
            ...
            <div className="group p-8 border border-[#1A1A1A] rounded-xl hover:border-[#008E97] transition-colors duration-300">
              ...
              <p className="text-[#A3A3A3] mt-4 mb-6">Available for corporate workshops and leadership events.</p>
            ...
            <div className="group p-8 border border-[#1A1A1A] rounded-xl hover:border-[#008E97] transition-colors duration-300">
              ...
              <p className="text-[#A3A3A3] mt-4 mb-6">Founder of IIC Networks. Creator of OneGoal Pro.</p>
              <span className="text-[#6B6B6B] text-sm">About IIC Networks</span>
            </div>
          </div>
        </div>
      </section>
