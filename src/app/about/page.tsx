        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-12">
            <div className="space-y-2">
              <span className="font-serif text-3xl md:text-5xl text-[#0A0A0A]">10+</span>
              <p className="text-[#6B6B6B] text-xs md:text-sm uppercase tracking-wider">Years Coaching</p>
            </div>
            <div className="space-y-2">
              <span className="font-serif text-3xl md:text-5xl text-[#0A0A0A]">5,000+</span>
              <p className="text-[#6B6B6B] text-xs md:text-sm uppercase tracking-wider">Professionals Trained</p>
            </div>
            <div className="space-y-2">
              <span className="font-serif text-3xl md:text-5xl text-[#0A0A0A]">2</span>
              <p className="text-[#6B6B6B] text-xs md:text-sm uppercase tracking-wider">Continents</p>
            </div>
            <div className="space-y-2">
              <span className="font-serif text-3xl md:text-5xl text-[#0A0A0A]">1</span>
              <p className="text-[#6B6B6B] text-xs md:text-sm uppercase tracking-wider">Book Coming Soon</p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-10 md:gap-16">
            <div className="space-y-4">
              ...
              <h3 className="font-serif text-xl md:text-2xl text-white">Know God.</h3>
            ...
            <div className="space-y-4">
              ...
              <h3 className="font-serif text-xl md:text-2xl text-white">Know yourself.</h3>
              <p className="text-[#A3A3A3] leading-relaxed text-sm md:text-base">
                Most people know their strengths. The work is knowing what lives in the shadow: the avoidance patterns, the blind spots, the version of you that shows up under pressure. You cannot govern what you have not faced.
              </p>
            </div>
            <div className="space-y-4">
              <span className="text-[#008E97] text-sm font-medium tracking-widest">03 /</span>
              <h3 className="font-serif text-xl md:text-2xl text-white">Know people.</h3>
              <p className="text-[#A3A3A3] leading-relaxed text-sm md:text-base">
      ...
      <section className="px-6 md:px-12 lg:px-20 py-16 md:py-24 bg-[#F0FAFB]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-12">
            <Link
              href="/forge-program"
              className="inline-flex items-center gap-2 text-[#008E97] font-medium hover:gap-3 transition-all text-sm md:text-base"
            >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6">
            <div className="group p-6 md:p-8 border border-[#1A1A1A] rounded-xl hover:border-[#008E97] transition-colors duration-300">
              ...
              <p className="text-[#A3A3A3] mt-3 mb-5 text-sm md:text-base">Identity-based coaching for professionals and leaders.</p>
            ...
            <div className="group p-6 md:p-8 border border-[#1A1A1A] rounded-xl hover:border-[#008E97] transition-colors duration-300">
              ...
              <p className="text-[#A3A3A3] mt-3 mb-5 text-sm md:text-base">Petty Little Things. 50 habits quietly ruining your life.</p>
