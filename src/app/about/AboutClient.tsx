...
export function AboutClient() {
  return (
    <main className="min-h-[100dvh] bg-white">
      ...
      {/* SECTION 1 — HERO */}
      <section className="relative px-6 md:px-12 lg:px-20 pt-28 pb-16 md:pt-36 md:pb-24 bg-white">
      ...
      <section className="px-6 md:px-12 lg:px-20 py-16 md:py-24 bg-[#f4fafb]">
        <div className="max-w-7xl mx-auto">
          <div className="mb-10">
            <span className="text-[#008E97] text-sm font-medium tracking-widest uppercase">
              The Work In Numbers
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-12">
            {[
              { num: `${CREDENTIALS.yearsCoaching}+`, label: "Years Coaching" },
              { num: `${CREDENTIALS.professionalsTrained.toLocaleString("en-GB")}+`, label: "Professionals Trained" },
              { num: `${CREDENTIALS.continents}`, label: "Continents" },
              { num: "1", label: `Book Published — ${CREDENTIALS.bookTitle} (${CREDENTIALS.bookYear})` },
            ].map((s) => (
              <div key={s.label} className="space-y-2">
                <span className="font-serif text-3xl md:text-5xl text-[#0f1f20]">{s.num}</span>
                <p className="text-[#7a9ea1] text-xs md:text-sm uppercase tracking-wider">{s.label}</p>
              </div>
            ))}
          </div>
          <div className="mt-10 pt-8 border-t border-[#E5E5E5]">
            <p className="text-[#7a9ea1] text-base md:text-lg">
              Founder, IIC Networks ({CREDENTIALS.founded}). Creator, The Forge System. Author, {CREDENTIALS.bookTitle}.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 md:px-12 lg:px-20 py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            ...
            <h2 className="font-serif text-2xl md:text-4xl lg:text-5xl text-[#0f1f20] mt-4 leading-tight">
              I did not stumble into this work.
            </h2>
          </div>

          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
            <div className="space-y-6 text-[#3d5a5c] text-base md:text-lg leading-relaxed">
              <p>
              ...
              <p>
                I founded IIC Networks that year with a simple conviction: influence, impact, and change are not things that happen to people. They are the result of becoming a particular kind of person. Over the next several years I trained over {CREDENTIALS.professionalsTrained.toLocaleString("en-GB")} professionals across Nigeria and the UK in personal development, leadership, and what it actually takes to operate at a higher level.
              </p>
              <p>
                In 2023 I relocated to the United Kingdom. The Forge System is what the previous decade was building toward — ten years of client work across two continents, distilled into a single structured process. Piece by piece, client by client, insight by insight.
              </p>
            </div>
            <div className="space-y-6 text-[#3d5a5c] text-base md:text-lg leading-relaxed">
              <p>
      ...
      <section className="px-6 md:px-12 lg:px-20 py-16 md:py-24 bg-[#f4fafb]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-3xl mb-12">
            <p className="text-[#7a9ea1] text-base md:text-lg leading-relaxed mb-6">
            ...
            <p className="text-[#0f1f20] text-base md:text-lg leading-relaxed font-medium">
          ...
          <div className="grid md:grid-cols-3 gap-10 md:gap-16">
            {[
              ...
              <div key={p.num} className="space-y-4">
                ...
                <h3 className="font-serif text-xl md:text-2xl text-[#0f1f20]">{p.title}</h3>
                <p className="text-[#7a9ea1] leading-relaxed text-sm md:text-base">{p.body}</p>
              </div>
            ))}
          </div>
      ...
      <section className="px-6 md:px-12 lg:px-20 py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-3xl mb-12">
            ...
            <p className="text-[#0f1f20] text-base md:text-lg leading-relaxed">
              ...
              {[
                ...
                <div key={item.num} className="relative pl-12 lg:pl-0">
                  ...
                  <div className="space-y-3">
                    ...
                    <h3 className="font-serif text-2xl md:text-3xl text-[#0f1f20]">{item.name}</h3>
                    <p className="text-[#7a9ea1] text-xs uppercase tracking-widest">{item.weeks}</p>
      ...
      <section className="px-6 md:px-12 lg:px-20 py-16 md:py-24 bg-[#f4fafb]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6">
            ...
            {/* Coach */}
            <div className="group border border-[#d0e8ea] rounded-2xl overflow-hidden hover:border-[#008E97]/50 transition-colors duration-300">
              ...
              <div className="p-6 md:p-8">
                ...
                <p className="text-[#3d5a5c] mt-3 mb-5 text-sm md:text-base">Identity-based coaching for professionals and leaders. One-to-one work that goes after the root, not the symptoms.</p>
                <Link href="/forge-program" className="inline-flex items-center gap-2 text-[#0f1f20] text-sm hover:text-[#008e97] transition-colors">
                  The Forge Program
                </Link>
              </div>
            </div>
            ...
            <div className="group border border-[#d0e8ea] rounded-2xl overflow-hidden hover:border-[#008E97]/50 transition-colors duration-300">
              ...
              <div className="p-6 md:p-8">
                ...
                <p className="text-[#3d5a5c] mt-3 mb-5 text-sm md:text-base">Petty Little Things. 50 habits quietly ruining your life and what the identity underneath each one is actually saying.</p>
                <Link href="/book" className="inline-flex items-center gap-2 text-[#0f1f20] text-sm hover:text-[#008e97] transition-colors">
                  The Book
                </Link>
              </div>
            </div>
            ...
            <div className="group border border-[#d0e8ea] rounded-2xl overflow-hidden hover:border-[#008E97]/50 transition-colors duration-300">
              ...
              <div className="p-6 md:p-8">
                ...
                <p className="text-[#3d5a5c] mt-3 mb-5 text-sm md:text-base">Available for corporate workshops, leadership events, and conference keynotes. The work translates to any room.</p>
                <Link href="https://calendly.com/olawolepelumisunday/30min" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-[#0f1f20] text-sm hover:text-[#008e97] transition-colors">
                  Book a Call
                </Link>
              </div>
            </div>
            ...
            <div className="group border border-[#d0e8ea] rounded-2xl overflow-hidden hover:border-[#008E97]/50 transition-colors duration-300">
              ...
              <div className="p-6 md:p-8">
                ...
                <p className="text-[#3d5a5c] mt-3 mb-5 text-sm md:text-base">Founder of IIC Networks. Builds the tools behind The Forge System — including OneGoal Pro, an AI-powered goal system on the same identity-first philosophy.</p>
              </div>
            </div>
      ...
      {/* SECTION 7 — CTA */}
      <section className="px-6 md:px-12 lg:px-20 py-16 md:py-24 bg-[#008e97]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-serif text-2xl md:text-4xl lg:text-5xl text-white mb-6">
            Ready to close the gap?
          </h2>
          <p className="text-white/80 text-base md:text-xl mb-8 max-w-2xl mx-auto">
