...
export default async function PodcastPage() {
  ...
  return (
    <main className="min-h-[100dvh] bg-white">
      ...
      {/* HERO */}
      <section className="relative min-h-[70vh] md:min-h-[80vh] flex items-center justify-center overflow-hidden bg-white pt-28 md:pt-36 pb-16 md:pb-20">
        ...
        <div className="relative z-10 px-6 md:px-12 text-center max-w-3xl mx-auto">
          <h1 className="font-serif text-4xl md:text-7xl lg:text-8xl text-[#0f1f20] leading-none mb-6 md:mb-8 tracking-tight">
            Influence Podcast
          </h1>
          ...
          <p className="text-[#3d5a5c] text-base md:text-lg leading-relaxed mb-10 md:mb-12 max-w-xl mx-auto">
          ...
          <div className="flex flex-row gap-4 justify-center">
            <Link
              ...
              className="inline-flex items-center justify-center bg-[#f4fafb] px-5 py-4 rounded-full hover:bg-[#e6f6f7] transition-colors border border-[#d0e8ea]"
            ...
            >
              <svg className="w-8 h-8 md:w-10 md:h-10 text-[#0f1f20]" viewBox="0 0 24 24" fill="currentColor">
      ...
      {/* SHOW DESCRIPTION */}
      <section className="px-6 md:px-12 lg:px-20 py-12 md:py-16 bg-[#f4fafb] border-y border-[#d0e8ea]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-6">
            <span className="text-[#7a9ea1] text-sm">Available on:</span>
            <Link
              href="https://open.spotify.com/show/1TbCBxMDNYrZj64hcWi3Zg"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#7a9ea1] hover:text-[#0f1f20] transition-colors"
      ...
      <section className="px-6 md:px-12 lg:px-20 py-16 md:py-24 bg-[#008e97]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link
            href="/forge-program"
            className="bg-white text-[#008e97] px-6 md:px-8 py-4 rounded-full font-medium hover:bg-[#e6f6f7] transition-colors inline-flex items-center gap-2"
          >
