  ...
  return (
    <main className="min-h-[100dvh] bg-white">
      <div className="max-w-3xl mx-auto px-6 lg:px-8 pt-32 pb-20 md:pt-40 md:pb-28">
        ...
        <div className="space-y-10 text-[#3d5a5c] text-base md:text-lg leading-relaxed">
          ...
          <section>
            <h2 className="font-serif text-xl md:text-2xl text-[#0f1f20] font-bold mb-4">Use of this website</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl md:text-2xl text-[#0f1f20] font-bold mb-4">Coaching services</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl md:text-2xl text-[#0f1f20] font-bold mb-4">Digital products and downloads</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl md:text-2xl text-[#0f1f20] font-bold mb-4">Intellectual property</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl md:text-2xl text-[#0f1f20] font-bold mb-4">Third-party links</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl md:text-2xl text-[#0f1f20] font-bold mb-4">Limitation of liability</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl md:text-2xl text-[#0f1f20] font-bold mb-4">Governing law</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl md:text-2xl text-[#0f1f20] font-bold mb-4">Changes to these terms</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl md:text-2xl text-[#0f1f20] font-bold mb-4">Contact</h2>
            <p>
