...
export async function PodcastSection() {
  ...
  return (
    <section id="podcast" className="py-24 bg-[#F0FAFB] relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="flex flex-wrap items-center gap-4">
              <a
                ...
                className="inline-flex items-center gap-2 bg-[#0A0A0A] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#008E97] transition-colors"
              >
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-[#008E97]/10">
            <div className="flex items-start gap-6">
              ...
              <div className="flex-1">
                <div className="text-xs text-[#008E97] font-semibold uppercase tracking-wider mb-2">
                  Latest Episode
                </div>
                <h3 className="text-xl font-bold text-[#0A0A0A] mb-2 font-['Fraunces']">
                ...
                <div className="flex items-center gap-4 text-xs text-[#6B7280]">
                  ...
                  {displayEpisode.itunes?.duration && (
                    <span>{displayEpisode.itunes.duration}</span>
                  )}
                </div>
              </div>
            </div>
