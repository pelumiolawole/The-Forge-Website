        ...
        <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-4">
              <a
                ...
                className="inline-flex items-center gap-2 bg-[#0f1f20] text-white px-5 py-3 rounded-lg font-semibold hover:bg-[#008e97] transition-colors text-sm"
              >
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg border border-[#008E97]/10">
            <div className="flex items-start gap-4 md:gap-6">
              <div className="w-24 h-24 md:w-32 md:h-32 rounded-xl bg-gradient-to-br from-[#008e97] to-[#006e75] flex items-center justify-center flex-shrink-0 overflow-hidden">
